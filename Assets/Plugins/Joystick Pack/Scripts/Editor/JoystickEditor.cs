...
public class JoystickEditor : Editor
{
    ...
    protected SerializedProperty alwaysShow;
    ...
    protected virtual void OnEnable()
    {
        ...
        alwaysShow = serializedObject.FindProperty("alwaysShow");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(alwaysShow, new GUIContent("Always Show", "Always show joystick."));
    }
